...
const householdContributionSchema = new mongoose.Schema({
  ...
  bundleId: { type: mongoose.Schema.Types.ObjectId, ref: 'HouseholdBundle', required: true }, // changed from itemId
  repaymentMonths: { type: Number, required: true, min: 1, max: 6 },
